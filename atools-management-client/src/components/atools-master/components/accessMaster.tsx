...
import AccessMasterDrawer from "../../common/drawer/AccessMaster";
...
function AccessMaster(props: any) {
  interface Sort {
    columnKey?: string;
    order?: any;
  }
  ...
  const modules = { View_Employee_Manager: "View Employee Manager", Edit_Employee_Manager: "Add/Edit Employee Manager", View_Master_Manager: "View Master Manager", Edit_Master_Manager: "Add/Edit Master Manager" };
  ...
  const getAcessData = () => {
    service.getData("/master/accessMaster", isSuccess, isError);
  ...
  const deleteSetConfirm = () => {
    service.deleteData(`/master/accessMaster/${deleteRecord}`, deleteSuccess, deleteError);
  };
  ...
  const columns = [
    ...
    {
      title: "Modules Accessible",
      dataIndex: "modulesAccess",
      key: "mods_documentible",
                  ...
                  title={
                    <>
                      <div className='Table_Tooltip'>
                        <p className='inter-body2-medium white'>Modules List</p>
                        <ul>
  ...
  return (
    <>
      <Layout>
        ...
        <Row gutter={[24, 24]} style={{ marginTop: 72 }} className='mx-0'>
          ...
          <Col xxl={{ span: 14 }} lg={{ span: 16 }} className='mt-3 white-bg px-0 py-3'>
            <Row className='mx-0 px-3' justify='space-between' style={{ marginBottom: 16, zIndex: 101 }}>
              <div>
                <h5 className='d-inline-flex align-items-center inter-headline1-bold'>{count} Access Manager Listed</h5>
              ...
              <div className='d-inline-flex'>
                ...
                <RBAC accessModules={["Edit_Master_Manager"]}>
                  <Button className='add-button mr-2 obutton' size='large' onClick={handleAdd}>
                    <PlusOutlined /> Add Access Manager
                  </Button>
                </RBAC>
              </div>
            </Row>
        ...
        <AccessMasterDrawer visible={AccessMasterd} drawerClose={drawerClose} data={editRecord} callback={handleCallback} editFlag={editFlag} />
      </Layout>
    </>
  );
}
